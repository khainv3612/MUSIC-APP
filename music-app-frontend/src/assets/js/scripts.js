    ...
    init: function () {
      ...
      new Chart(t, {
        ...
        options: {
          responsive: !0,
          legend: {display: !1},
          scales: {yAxes: [{display: !1, ticks: {min: 0, max: 85}}], xAxes: [{display: !1}]},
      ...
      new Chart(t, {
        ...
        options: {
          responsive: !0,
          legend: {display: !1},
          scales: {yAxes: [{display: !1, ticks: {min: 0, max: 85}}], xAxes: [{display: !1, barPercentage: .5}]},
          layout: {padding: 0, margin: 0}
        }
      })
    }, purchase: function () {
      ...
      new Chart(t, {
        ...
        options: {
          responsive: !0,
          legend: {display: !1},
          scales: {yAxes: [{ticks: {min: 0, max: 80}}], xAxes: [{barPercentage: .3}]},
          layout: {padding: 0, margin: 0}
        }
      })
    }
  ...
  AppConfig = {
    init: function () {
      ...
      $(t).slick({
        ...
        }, {breakpoint: 640, settings: {slidesToShow: a}}, {breakpoint: 380, settings: {slidesToShow: 1, arrows: !1}}]
      })
      ...
      var t = $(".line-tabs .nav-item .active"), s = $(".line-tabs .nav-item");
      $(".line-tabs").append("<span class='tabs-link-line'></span>");
      var e = t.position(), i = t.parent().width();
      $(".tabs-link-line").stop().css({width: i}), s.on("click", function () {
      ...
      t.on("click", function (t) {
        ...
        if (i.length && !e.find(".custom-card--labels li .la-heart").length) i.append(s); else {
...
$(function () {
  AudioPlayer = {
    init: function () {
      ...
      var t = $('.audio-volume input[type="range"]'), s = $(".audio-volume .btn");
      t.on("change", function () {
        var t = $(this), e = parseInt(t.val(), 10);
  ...
  function a(e, i) {
    this.$body = t("body"), this.options = t.extend({}, a.Defaults, i), this.cookiesOptions = {
      themeDark: this.options.darkTheme,
      header: this.options.header,
      sidebar: this.options.sidebar,
      player: this.options.player
    }, null != t.cookie("themeSetting") && !1 === i && (this.cookiesOptions = JSON.parse(t.cookie("themeSetting")), this.options.darkTheme = this.cookiesOptions.themeDark, this.options.header = this.cookiesOptions.header, this.options.sidebar = this.cookiesOptions.sidebar, this.options.player = this.cookiesOptions.player), this.optionList = [{
      text: "Dark Theme",
      value: this.options.darkTheme
    }];
    var o = s.location.pathname.split("/").pop().split(".")[0], n = ["index", "error"].includes(o);
    o && !n && this.initialize()
  }
  ...
  a.Defaults = {
    ...
    var s = t("#header"), e = t("#sidebar"), i = t("#audioPlayer");
    this.options.darkTheme && this.$body.addClass("theme-dark"), s.addClass("bg-" + this.options.themeClass[this.options.header]), e.addClass("sidebar-" + this.options.themeClass[this.options.sidebar]), i.addClass("player-" + this.options.themeClass[this.options.player]), this.settingsButtonElement(), this.skinClicks()
    ...
    for (var s = '<div class="theme-settings-body"><ul class="' + this.options.listClass + '">', i = 0; i < this.optionList.length; i++) {
      ...
      s += '<li class="' + this.options.listItemClass + '"><label for="to' + i + '">' + this.optionList[i].text + '</label><div class="custom-control custom-checkbox ml-auto"><input type="checkbox" class="custom-control-input" id="to' + i + '" ' + a + '><label class="custom-control-label" for="to' + i + '"></label></div></li>'
    }
    ...
    s += "</li>", s += "</ul></div>", t.innerHTML = '<header><span class="title-bold font-md text-uppercase">Theme Settings</span><a href="javascript:void(0)" class="ml-auto"><i class="ion-md-close"></i></a></header>' + s, this.$body.append(t)
  }, a.prototype.skinClicks = function () {
    var s = this, e = "#" + s.options.settingsButtonId, i = t("#" + s.options.wrapperId), a = t("#header"),
      o = t("#sidebar"), n = t("#audioPlayer"), l = t(".header-skin"), r = t(".sidebar-skin"), d = t(".player-skin");
    this.$body.on("click", "#to0", function () {
      ...
      var e = t(this), i = e.data("header-skin");
      ...
      var e = t(this), i = e.data("sidebar-skin");
      ...
      var e = t(this), i = e.data("player-skin");
